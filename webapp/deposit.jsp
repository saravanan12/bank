...
<div id="navigation">
    ...
    <li><a href="logout.jsp">LOGOUT</a></li> -->
     ...
     <ul>
    <li><a onclick="Navigation.navigate('balance')">BALANCE</a></li>
    <li><a onclick="Navigation.navigate('deposit')">DEPOSIT</a></li>
    <li><a onclick="Navigation.navigate('withdraw')">TRANSFER</a></li>
    <li><a onclick="Login.signOut()">LOGOUT</a></li>
      </ul>
</div>
    ...
    <td width="1200" valign="top">
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				    <table id="depositTable" cellspacing="5" cellpadding="3">
					 <!-- <tr><td>CHECK NO:</td><td> <input type="text" name="cno"/></td></tr> -->
				    <tr><td>CUSTOMER ID:</td> <th name="customerId">  </th></tr>
					<tr><td>USER NAME:</td><th name="username">  </th> </tr>
					<tr><td>AMOUNT:</td><td> <input type="text" name="amount"/></td></tr>
					<!-- Gender:<br/><br/>
					Male<input type="radio" name="gender" value="male"> Female<input type="radio" name="gender" value="female"/><br/><br/> -->
					
					<tr><td></td><td>
					<button class="button" onclick="Transactions.deposit()" type="button">Submit</button>
					<!-- <input onclick="Transactions.deposit()" type="submit" value="Submit"/> -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
document.onload = Transactions.depositInit();
</script>
</div>
